...
export async function providerCall(db, uid, task, body, { importID=null, sessionID=null, endpoint='chat/completions', multipart=false }={}) {
  ...
  await ref.set({uid,task,importID,sessionID,provider:'xai',requestedModel:model,promptVersion:'companion-4',schemaVersion:3,startedAt,status:'started'});
  try {
